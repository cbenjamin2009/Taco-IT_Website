       ...
       <section class="w-full h-auto min-h-screen mx-4 py-2" id="about">
            ...
            <div class="p-2 w-full mx-auto">
                ...
                <p className="text-xs md:text-md ml-4 xl:text-lg leading-5">Taco-IT was founded by Chris Benjamin to provide Technology services to local businesses in the Pacific Northwest. We exist to help give a technological edge to businesses who typically do not have their own 
                    ...
                    <p className="text-xs md:text-md ml-4 xl:text-lg leading-5">Chris has worked for several local technology companies from a local school district, a pharmacy support company, and as a the IT Manager for a medium size medical practice. 
                ...
                <p className="text-md md:text-1xl font-bold leading-tight lg:leading-loose mb-2 mt-2 ">Our Why:</p>
                ...
                <p className="text-md md:text-1xl font-bold leading-tight lg:leading-loose mb-2 mt-2 ">Our Mission: </p>
                ...
                <p className="text-md md:text-1xl font-bold leading-tight lg:leading-loose mb-2 mt-2 ">Our What:</p>
                ...
                <p className="text-md md:text-1xl font-bold leading-tight lg:leading-loose mb-2 mt-2 ">Our How:</p>
