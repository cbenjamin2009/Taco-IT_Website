    ...
    return (
        <div className="skills mt-6 w-full mx-auto justify-center text-center">
            <div className="skillsGrid w-full grid sm:grid-cols-3 lg:grid-cols-5 grid-cols-4 gap-6 mx-auto ">
                ...
                <Skill source="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/firebase/firebase-plain-wordmark.svg" alt="The logo icon for Firebase" title="Firebase Auth and Data"/>
                ...
                <Skill source="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/markdown/markdown-original.svg" alt="The logo icon for Markdown" title="Markdown"/>
                <Skill source="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mongodb/mongodb-original-wordmark.svg" alt="The logo icon for MongoDB" title="Mongo DB"/>
                ...
                <Skill source="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original-wordmark.svg" alt="The logo icon for Python" title="Python"/>
                ...
                <Skill source="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/socketio/socketio-original.svg" alt="The logo icon for SocketIO" title="Socket.IO"/>
                <Skill source="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/microsoftsqlserver/microsoftsqlserver-plain-wordmark.svg" alt="The logo icon for Microsoft SQL Server" title="Micrsooft SQL Server"/>
