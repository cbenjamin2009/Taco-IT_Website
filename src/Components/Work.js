...
function Work() {
    return (
        ...
        <div className="my-work" id="work">
            ...
            <Project id={"8"} link={"https://cbenjamin2009.github.io/Wildfire-Tracker/index.html"} image={Project08Thumb} alt={"A map showing live wildfire locations"} label={"A wild fire tracker using Nasa provided information"} />
