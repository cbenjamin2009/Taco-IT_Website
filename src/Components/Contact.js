...
function Contact() {
    ...
    return (
        <section id="contact" className="max-w-screen-md mx-auto p-2 ">
        <div className="">
            <h2 className=" text-center text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight text-gray-900 capitalize">Contact us <span className="text-indigo-600">today</span></h2>
